...
APPLICATION_CONFIG = {
    ...
    'description': _(
        'This application will find the cheap flights based on your origin, destination and price thresholds'),
...
SUIT_CONFIG = {
    ...
    'MENU': (
        ...
        # Others
        '-',
        {'label': 'Documentation', 'icon': 'icon-bookmark', 'url': 'https://github.com/Loomba/cheap-flights-finder/wiki'},
        {'label': 'Report a bug', 'icon': 'icon-comment', 'url': 'http://github.com/Loomba/cheap-flights-finder/issues'},
    ),
    # misc
    'LIST_PER_PAGE': 50
}
